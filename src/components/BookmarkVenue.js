...
export default function BookmarkVenue(props) {
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={2}>
                    ...
                    <Typography style={{ paddingTop: "50%" }}>
                        <Link style={{ textDecoration: "none" }} onClick={() => props.onRemoveBookmark(props.venue.Venue.venue_id)}>Remove Bookmark</Link>
                    </Typography>
                </Grid>
            </Grid>
        </Card>
